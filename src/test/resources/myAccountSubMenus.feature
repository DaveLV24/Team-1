...
Feature: My Account page sub menus
  ...
  Scenario: Access menu items missing in My Account page
    Then I see wish list option in the navigation bar
    And I see logout option in the navigation bar
  ...
  Scenario: Personal information is displayed in input fields
    When I click on my email in the navigation bar
    And I am redirected to My Account page
    And I click on Constomers info menu option
